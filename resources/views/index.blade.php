...
@section('content')
    <div class="space-y-6 sm:space-y-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-4 sm:gap-6">
            ...
            <!-- Arsip Card -->
            <div class="card-dark group hover:border-gray-500/50 transition-all duration-300">
                <div class="flex items-center justify-between mb-4">
                    <div class="w-10 h-10 rounded-xl bg-gray-500/10 flex items-center justify-center text-gray-500 border border-gray-500/20 group-hover:scale-110 transition-transform">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 8h14M5 8a2 2 0 110-4h14a2 2 0 110 4M5 8v10a2 2 0 002 2h10a2 2 0 002-2V8m-9 4h4" />
                        </svg>
                    </div>
                </div>
                <h3 class="text-gray-400 text-xs font-medium">Diarsipkan</h3>
                <div class="text-3xl font-bold text-white mt-1 card-value">{{ $arsip }}</div>
                <div class="mt-2 flex items-center gap-1">
                    <span class="text-[10px] text-gray-500/80 font-bold">Data Disimpan</span>
                </div>
            </div>
        </div>
                ...
                <div class="card-dark p-6 bg-gradient-to-br from-gray-800 to-gray-900 border-none shadow-xl">
                    <div class="flex items-center gap-4 mb-6">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-gray-400">Selamat datang kembali di dashboard.</p>
                        </div>
                    </div>
                ...
                <div class="card-dark p-6">
                    <div class="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p class="text-[10px] text-gray-500 uppercase tracking-widest font-bold">Volume dalam 7 hari terakhir</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-end justify-between gap-3 h-48 px-2">
                        ...
                        @foreach($dataMingguan as $index => $data)
                            <div class="flex-1 flex flex-col items-center gap-3 group relative h-full justify-end">
                                <div class="bg-gradient-to-t from-green-primary/40 to-green-primary w-full max-w-[40px] rounded-lg group-hover:from-green-primary transition-all duration-500 shadow-lg shadow-green-500/5 relative" 
